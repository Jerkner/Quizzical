...
export default function App() {
    ...
    function generateAnswerElements(answersArray, questionIndex) {
        ...
        return groupedAnswers.map((group, groupIndex) => (
            <div key={groupIndex} className="answer-group">
                {group.map((answer, answerIndex) => {
                    ...
                    return (
                        <label key={answerIndex} className={className}>
                            <input
                                type="radio"
        ...
        <main className='questions-main'>
            {(!questionsArray.length && !showResult) ? (
                ...
                <div className='start-content'>
                    ...
                    <h2 className='start-instructions'>Press the button to generate your questions</h2>
                ...
                <div className='questions-content'>
                    ...
                    <div className='result-content'>
                        <div className='result-container'>
                            <h3 className='result-text'>You scored {score}/{questionsArray.length} correct answers</h3>
                            <button onClick={generateQuestions}
